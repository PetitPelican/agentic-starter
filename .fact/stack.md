...
[À remplir — langages, frameworks, base de données, cloud. Ce qui est **en
place**, pas ce qui est envisagé : une intention se range dans `todo.md`.]
...
_La section qu'on lit **avant** d'ajouter une dépendance._

- [à remplir — les choix d'outillage regrettés, et ce qui les remplacerait]
