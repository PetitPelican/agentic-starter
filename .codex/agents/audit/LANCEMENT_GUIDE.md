...
1. **Ouvre une nouvelle session Codex** — ne réutilise pas une session existante
...
Les sessions d'un même audit ne se chevauchent pas — elles peuvent tourner en parallèle si tu as plusieurs instances Codex disponibles :
...
## Si Codex s'arrête en cours de route
