...
Avant toute chose, lis le fichier `.codex/agents/audit/_HEADER_COMMUN.md` intégralement. Ce fichier contient le contexte projet, les règles d'audit et les instructions de cartographie. Applique toutes ses instructions avant de commencer l'audit ci-dessous.

Cette session couvre **1 catégorie sur 5** — la plus dense en points de contrôle. Lance-la dans une nouvelle session Codex, indépendamment de A1 et A2.
