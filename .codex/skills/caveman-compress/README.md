...
A Codex skill that compresses your project memory files (`AGENTS.md`, todos, preferences) into caveman format — so every session loads fewer tokens automatically.

Codex reads `AGENTS.md` on every session start. If file big, cost big. Caveman make file small. Cost go down forever.
...
```
AGENTS.md          ← compressed (Codex reads this — fewer tokens every session)
...
|------|----------:|----------:|------:|
| `agent-md-preferences.md` | 706 | 285 | **59.6%** |
| `project-notes.md` | 1145 | 535 | **53.3%** |
| `agent-md-project.md` | 1122 | 636 | **43.3%** |
...
Skills live in `.codex/skills/`. Copy `caveman-compress/` into your project's `.codex/skills/` folder.
...
detect file type        (no tokens)
        ↓
Model compresses       (tokens — one call)
        ↓
